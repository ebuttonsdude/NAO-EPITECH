...
def wordlist_bonus( nOccurenceModel = 2 ):
    "return a list word of a certain type/function, using some frequency model"
    listword  = ["grave.", "c'est bizarre.", "ne trouves tu pas?",  "tro ouf!",  "trop zarbi, non?", "plom.", "mince!", "peuchêre." ];
    listword = wordlist_AddOccurenceModel( listword, nOccurenceModel );
    return listword;
# wordlist_bonus - end
...
def autoTest():
    ...
    print( generateQuestionAboutThings( "rose" ) + generateBof() ); # eg: parbleu une fois j'ai vu quelque chose qui me rappelle  ce truc rose  , plom. ? ca n'a rien de particulierement intéressant ! peuchêre. 
